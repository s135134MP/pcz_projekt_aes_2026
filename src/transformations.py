"""Manual AES-128 helpers used by the project."""
...
def bytes_to_state(block):
    """Convert a 16-byte block into the project state matrix."""
    if len(block) != 16:
        raise ValueError("State block must contain exactly 16 bytes")
